...
from rest_framework.serializers import ModelSerializer, SlugRelatedField, StringRelatedField, EmailField
...
class BooksSerializer(ModelSerializer):
    tags = SlugRelatedField(slug_field='slug', queryset=Tags.objects.all(), many=True)
    type = BookTypeSerializer()
    author = MinimalAuthorSerializer()

    class Meta:
        model = Book
        fields = ('title', 'description', 'published', 'publish_date', 'tags', 'type', 'author')
